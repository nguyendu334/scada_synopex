...
function myClientConnected() {
  MQTT_CLIENT.subscribe("SYNOPEXVINA2/IIOT/MQTT/SYSTEMDI");
...
function pumpOnOff(data) {
    ...
    if (ediwaterpumpTop3old != data[0].dataEDIline1.pump3) {
        ediwaterpumpTop3old = data[0].dataEDIline1.pump3;
        if (data[0].dataEDIline1.pump3 == 1) {
...
function ledOnOf(data) {
    ...
    var LedEdisystem2CTop = document.getElementById("LedEdisystem2CTop");
    ...
    if (data[0].dataEDIline1.EDI3 == 1) {
        LedEdisystem2ATop.classList.add("on");
    } else {
        LedEdisystem2ATop.classList.remove("on");
    }
    if (data[0].dataEDIline1.EDI2 == 1) {
        LedEdisystem2BTop.classList.add("on");
    } else {
        LedEdisystem2BTop.classList.remove("on");
    }
    if (data[0].dataEDIline1.EDI1 == 1) {
        LedEdisystem2CTop.classList.add("on");
    } else {
        LedEdisystem2CTop.classList.remove("on");
    }
    ...
    var Client4_46_502 = document.getElementById("Client4_46_502");
    var Client5_32_8000 = document.getElementById("Client5_32_8000");
    ...
    if (data[0].Connect.Client4 == 1) {
        Client4_46_502.classList.add("on");
    } else {
        Client4_46_502.classList.remove("on");
    }
    if (data[0].Connect.Client5 == 1) {
        Client5_32_8000.classList.add("on");
    } else {
        Client5_32_8000.classList.remove("on");
    }
}
//Báo RO System
...
function dataConductivity(data) {
    ...
    var dataEDIResistivity1B_3 = document.getElementById("dataEDIResistivity1B_3");
    var dataEDIResistivity1B_2 = document.getElementById("dataEDIResistivity1B_2");
    var dataEDIResistivity1B_1 = document.getElementById("dataEDIResistivity1B_1");
    ...
    dataEDIResistivity1B_1.innerHTML = data[0].Resistivity.ResDI1.toFixed(2);
    dataEDIResistivity1B_2.innerHTML = data[0].Resistivity.ResDI2.toFixed(2);
    dataEDIResistivity1B_3.innerHTML = data[0].Resistivity.ResDI3.toFixed(2);
    dataResistivity4.innerHTML = data[0].dataMenterline1.flow2.toFixed(2);

    dataConductivity5.innerHTML = data[0].dataMenterLine2.cond6.toFixed(2);
    dataConductivity6.innerHTML = data[0].dataMenterLine2.cond5.toFixed(2);
    dataConductivity7.innerHTML = data[0].dataMenterLine2.cond8.toFixed(2);
    dataConductivity8.innerHTML = data[0].dataMenterLine2.cond7.toFixed(2);
}
...
//khai báo dữ liệu hiển thị Chart kèm tên dữ liệu
var data = {
    labels: xValues,
    datasets: [
        {
...
// khai báo chỉnh sửa hiển thị như Font, max min
const config = {
    type: 'bar',
    data: data,
    options: {
...
//Xuất Chart đến element ctx với chỉnh sửa hiển thị
