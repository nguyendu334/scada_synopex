...
function valve(idIframe, color) {
  return document
    .querySelector(idIframe)
    .getSVGDocument()
    .getElementById("rect65118")
    .setAttribute("fill", color);
}
...
function valve1(idIframe, boolean, colorOn, colorOff) {
  if (boolean == 1) {
    return document
      .querySelector(idIframe)
      .getSVGDocument()
      .getElementById("rect65118")
      .setAttribute("fill", colorOn);
  } else {
    return document
      .querySelector(idIframe)
      .getSVGDocument()
      .getElementById("rect65118")
      .setAttribute("fill", colorOff);
  }
}
